    ...
    () =>
      Effect.gen(function* () {
        ...
        expect(ghCalls).toContain(
          "pr list --head jasonLaster:statemachine --state all --limit 20 --json number,title,url,baseRefName,headRefName,state,mergedAt,updatedAt,isDraft,headRefOid,isCrossRepository,headRepository,headRepositoryOwner",
        );
      }),
    20_000,
  );
