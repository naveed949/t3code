...
export interface ThreadDetailScreenProps {
  ...
  readonly onArchiveWorkflow?: () => void;
  readonly onReopenWorkflow?: () => void;
  readonly onPreflightWorkflowCleanup?: () => void;
  readonly onConfirmWorkflowCleanup?: () => void;
              ...
              {props.workflowAttachmentHint?.status === "available" || props.workflowAttachment ? (
                ...
                >
                  <WorkflowAttachmentCard
                    ...
                    onArchive={props.onArchiveWorkflow}
                    onReopen={props.onReopenWorkflow}
                    onPreflightCleanup={props.onPreflightWorkflowCleanup}
                    onConfirmCleanup={props.onConfirmWorkflowCleanup}
